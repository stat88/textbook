...
# **3.** 
# Refer to the regression of active pulse rate on resting pulse rate in [Section 12.2](http://stat88.org/textbook/notebooks/Chapter_12/02_The_Distribution_of_the_Estimated_Slope.html). Here are the estimated values again, along with some additional data.
